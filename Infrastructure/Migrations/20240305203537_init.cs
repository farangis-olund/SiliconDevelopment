        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckBoxs = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionSection", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DarkTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DarkImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LightTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LightImage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPlatformEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPlatformEntity_DownloadApp_DownloadAppId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntegrationTools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IntegrationTools_Integration_IntegrationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPlatformEntity_DownloadAppId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntegrationTools_IntegrationId",
                table: "IntegrationTools",
